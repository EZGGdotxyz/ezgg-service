...
export const MemberSmartWalletScalarFieldEnumSchema = z.enum(['id','deleted','createBy','updateBy','createAt','updateAt','deleteAt','memberId','did','platform','chainId','address']);

export const BlockChainScalarFieldEnumSchema = z.enum(['id','deleted','createBy','updateBy','createAt','updateAt','deleteAt','platform','chainId','network','name','show','sort','alchemyRpc','alchemyNetwork','tokenSymbol','tokenPrice','smartWalletType']);

export const TokenContractScalarFieldEnumSchema = z.enum(['id','deleted','createBy','updateBy','createAt','updateAt','deleteAt','address','platform','chainId','network','erc','tokenName','tokenSymbol','tokenDecimals','logo','show','sort','priceCurrency','priceValue','priceUpdateAt','priceAutoUpdate','feeSupport']);
...
export const MemberSmartWalletOrderByRelevanceFieldEnumSchema = z.enum(['did','address']);
...
export const TransactionHistoryOrderByRelevanceFieldEnumSchema = z.enum(['transactionCode','bizContractAddress','senderDid','senderWalletAddress','receiverDid','receiverWalletAddress','transactionHash','tokenSymbol','tokenContractAddress','tokenPrice','amount','message']);
...
export type BlockChainSmartWalletTypeType = `${z.infer<typeof BlockChainSmartWalletTypeSchema>}`
...
export const BlockChainSchema = z.object({
   ...
   */
  smartWalletType: BlockChainSmartWalletTypeSchema.describe("当前链上用户智能钱包类型： PRIVY、BICONOMY"),
  /**
   * 主键
   */
  id: z.number().int().describe("主键"),
